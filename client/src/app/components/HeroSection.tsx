...
export default function HeroSection() {
  return (
    <section className="w-full">
      ...
      {/* ── Story Text ───────────────────────────────────── */}
      <div className="max-w-[680px] mx-auto px-4 sm:px-6 text-center py-6 sm:py-8 md:py-10 text-gray-700 space-y-5 font-poppins font-extralight italic text-[11px] leading-relaxed">
        <p>
